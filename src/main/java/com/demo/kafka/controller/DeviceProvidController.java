...
@Slf4j
@RestController(value = "/deviceProvider")
@Api(tags = "Kafka Device发布测试", description = "kafka")
public class DeviceProvidController {
    ...
    public void produceWithProtobuf(@RequestBody Device device){
        try {
    ...
    public void produceWithJson(@RequestBody Device device){
        try {
